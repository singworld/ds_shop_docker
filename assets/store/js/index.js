                ...
                ,done: function(page, next){ //执行下一页的回调
                    ...
                    success : function(res) {
                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                html += '<div class="name" style="color: #000000;font-weight: 600;">'+item.name+'</div>';
                                ...
                                if(item.price <=0){
                                    ...
                                    buy = '<div style="height: 1rem"><span class="buy" style="background: #ff8000;color:#fff;display: inline-block;height: 1.1rem;line-height: 1rem;float: right;padding: 0rem 0.35rem;width:100%;border-radius: 0.1rem;    border: 1px solid transparent;text-align:center;">购买</span></div>';
                                }
                                ...
                                html += '<div class="price" style="margin-top: 0.2rem;"><span class="text" style="color: #ff8000;"> <p class="minprice">￥'+item.price+'</p> </span>'+buy+'</div>';
                                html += '</div>';
                                html += '</a>';
                                lis.push(html);
                            });
